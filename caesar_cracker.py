...
bg_image = ctk.CTkImage(Image.open("Images/bgimage1.png"),size=(760,460))
...
decrypt_button = ctk.CTkButton(root, text="Decrypt",text_color="gray",fg_color="black", command=decrypt_message)
